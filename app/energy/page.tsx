...
export default function EnergyPage() {
  ...
  const meters = useMemo(() => [
    { key: '1', id: 'EZ-001', name: t.nrg.meterMainElec, type: 'elec', value: '148.5 kW', daily: '2,847 kWh', floor: t.nrg.wholeBuilding, manufacturer: 'Siemens PAC3200', status: 'online' },
    { key: '2', id: 'EZ-002', name: t.nrg.meterEgSub, type: 'elec', value: '28.3 kW', daily: '542 kWh', floor: 'EG', manufacturer: 'Siemens 7KT1260', status: 'online' },
    { key: '3', id: 'EZ-003', name: t.nrg.meterOg1Sub, type: 'elec', value: '42.1 kW', daily: '806 kWh', floor: 'OG1', manufacturer: 'Siemens 7KT1260', status: 'online' },
    { key: '4', id: 'EZ-004', name: t.nrg.meterOg2Sub, type: 'elec', value: '35.8 kW', daily: '688 kWh', floor: 'OG2', manufacturer: 'Siemens 7KT1260', status: 'online' },
    { key: '5', id: 'EZ-005', name: t.nrg.meterOg3Sub, type: 'elec', value: '22.5 kW', daily: '432 kWh', floor: 'OG3', manufacturer: 'Siemens 7KT1260', status: 'online' },
    { key: '6', id: 'EZ-006', name: t.nrg.meterUgSub, type: 'elec', value: '19.8 kW', daily: '379 kWh', floor: 'UG', manufacturer: 'Siemens 7KT1260', status: 'online' },
    { key: '7', id: 'WMZ-001', name: t.nrg.meterHeatMain, type: 'heat', value: '85.2 kW', daily: '1,540 kWh', floor: t.nrg.wholeBuilding, manufacturer: 'Kamstrup MULTICAL 803', status: 'online' },
    { key: '8', id: 'WMZ-002', name: t.nrg.meterNorthHeat, type: 'heat', value: '32.5 kW', daily: '580 kWh', floor: t.nrg.northWing, manufacturer: 'Kamstrup MULTICAL 603', status: 'online' },
    { key: '9', id: 'WMZ-003', name: t.nrg.meterSouthHeat, type: 'heat', value: '28.1 kW', daily: '510 kWh', floor: t.nrg.southWing, manufacturer: 'Kamstrup MULTICAL 603', status: 'online' },
    { key: '10', id: 'WMZ-004', name: t.nrg.meterDhwHeat, type: 'heat', value: '12.8 kW', daily: '245 kWh', floor: 'UG', manufacturer: 'Kamstrup MULTICAL 603', status: 'online' },
    { key: '11', id: 'WZ-001', name: t.nrg.meterWaterMain, type: 'water', value: '2.3 m³/h', daily: '38.5 m³', floor: t.nrg.wholeBuilding, manufacturer: 'Sensus iPERL', status: 'online' },
    { key: '12', id: 'WZ-002', name: t.nrg.meterCanteenWater, type: 'water', value: '0.8 m³/h', daily: '12.2 m³', floor: 'EG', manufacturer: 'Sensus iPERL', status: 'online' },
    { key: '13', id: 'KZ-001', name: t.nrg.meterCooling, type: 'heat', value: '42.0 kW', daily: '620 kWh', floor: t.nrg.wholeBuilding, manufacturer: 'Kamstrup MULTICAL 803', status: 'online' },
    { key: '14', id: 'GZ-001', name: t.nrg.meterGas, type: 'heat', value: '12.3 m³/h', daily: '185 m³', floor: 'UG', manufacturer: 'Elster BK-G25', status: 'online' },
  ], [t])
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div><Title level={4} style={{ margin: 0 }}>{t.nav.energy}</Title><Text type="secondary">{t.nrg.subtitle} · {meters.length} {t.nrg.meters} · M-Bus / BACnet</Text></div>
        <Space>
