...
const zones = [
  { key: '1', name: 'OG1 Großraumbüro Nord', actual: 23.4, setpoint: 23.0, valve: 68, kp: 2.5, ki: 0.8, kd: 0.3, status: 'cooling', ddcAddr: 'DDC-OG1-01.AO3' },
  { key: '2', name: 'OG1 Großraumbüro Süd', actual: 22.8, setpoint: 23.0, valve: 12, kp: 2.5, ki: 0.8, kd: 0.3, status: 'idle', ddcAddr: 'DDC-OG1-01.AO4' },
  { key: '3', name: 'OG2 Bürozone West', actual: 24.1, setpoint: 23.0, valve: 82, kp: 2.2, ki: 0.7, kd: 0.2, status: 'cooling', ddcAddr: 'DDC-OG2-01.AO3' },
  { key: '4', name: 'OG2 Konferenz 2.10', actual: 25.2, setpoint: 23.0, valve: 95, kp: 3.0, ki: 1.0, kd: 0.4, status: 'cooling', ddcAddr: 'DDC-OG2-02.AO1' },
  { key: '5', name: 'OG3 Bürozone Ost', actual: 22.6, setpoint: 23.0, valve: 8, kp: 2.0, ki: 0.6, kd: 0.2, status: 'idle', ddcAddr: 'DDC-OG3-01.AO3' },
  { key: '6', name: 'OG3 Konferenz 3.12', actual: 24.8, setpoint: 23.0, valve: 88, kp: 3.0, ki: 1.0, kd: 0.4, status: 'cooling', ddcAddr: 'DDC-OG3-02.AO1' },
  { key: '7', name: 'EG Empfangsbereich', actual: 23.2, setpoint: 23.0, valve: 22, kp: 2.0, ki: 0.6, kd: 0.2, status: 'idle', ddcAddr: 'DDC-EG-01.AO3' },
  { key: '8', name: 'UG Serverraum', actual: 21.1, setpoint: 21.0, valve: 35, kp: 1.5, ki: 0.5, kd: 0.1, status: 'cooling', ddcAddr: 'DDC-UG-01.AO1' },
]
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      ...
      <Row gutter={[16, 16]}>
        ...
        <Col xs={24} sm={12} lg={6}><Card hoverable><Statistic title={t.cool.cop} value={4.35} valueStyle={{ color: '#52c41a' }} prefix={<DashboardOutlined />} /><Text type="secondary">Nenn-COP: 4.8</Text></Card></Col>
      </Row>

      <Card title={t.cool.pidCurve} extra={<Text type="secondary">Zone: OG2 Konferenz 2.10 · Abtastzeit 15s</Text>}>
      ...
      <Card title={t.cool.pidParams} extra={<Text type="secondary">{zones.length} Regelzonen · Siemens PXC Compact</Text>}>
        <Table columns={cols} dataSource={zones} pagination={false} size="small" scroll={{ x: 1100 }} />
      </Card>

      <Card title="Kälteanlage" size="small">
        <Descriptions bordered size="small" column={{ xs: 1, sm: 2, lg: 4 }}>
          <Descriptions.Item label="Kältemaschine 1">Carrier 30RB-262 · 130kW · <Tag color="green">Betrieb</Tag></Descriptions.Item>
          <Descriptions.Item label="Kältemaschine 2">Carrier 30RB-262 · 130kW · <Tag color="orange">Standby</Tag></Descriptions.Item>
          <Descriptions.Item label="Kältemittel">R-410A · Füllmenge 28kg je</Descriptions.Item>
          <Descriptions.Item label="Rückkühlung">Kühlturm BAC FXT-18 · 32°C</Descriptions.Item>
          <Descriptions.Item label="Pufferspeicher">1.500L · 7.2°C</Descriptions.Item>
          <Descriptions.Item label="Betriebsstunden">6,820h / 3,140h</Descriptions.Item>
          <Descriptions.Item label="Nächste Wartung">2026-05-10</Descriptions.Item>
          <Descriptions.Item label="Verdichter-Stufe">75% / 0%</Descriptions.Item>
        </Descriptions>
      </Card>

      <Modal title={`${t.cool.adjustPid} - ${selectedZone?.name || ''}`} open={pidModal} onOk={() => { setPidModal(false); message.success('PID-Parameter aktualisiert') }} onCancel={() => setPidModal(false)} okText={t.actions.save} cancelText={t.actions.cancel}>
